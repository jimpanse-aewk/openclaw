...
3. **(scheduled session)** Haiku → Sonnet switch: decision record, live edit of `openclaw.json`, restart, verify both agents respond. Blocked on TODO credit top-up (see Live issues).
...
## Reference
- `docs/OPENCLAW_HANDOVER.md` — 792-line operator handover (v2 2026-04-14, mirrored from `~/.openclaw/OPENCLAW_HANDOVER.md` on the host). Canonical for routing, schemas, CLI, known gotchas.
